class fibonacci:
    ...
    def menu(self):
        ...
        def __test_code_integrity():
            print("resusable", get_reusable_fibonacci(10))
            print("get iths", get_ith_fibonacci(10))
            print("get upto ith", get_upto_ith_fibonacci(10))
            print("fibonaccichecker", fibonacci_checker(34))
            print("fibs this index", fibonacci_this_Index_Range(0, 10))
            print("fibs this number", fibonacci_this_number_Range(0, 40))
            print("recursive fibs", fibonacci_recurcive(10))
